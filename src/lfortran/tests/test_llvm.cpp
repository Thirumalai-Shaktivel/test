...
f = 5
    ...
    LCompilers::AST::TranslationUnit_t* tu = TRY(LCompilers::parse(al, source,
        diagnostics));
    LCompilers::AST::ast_t* ast = tu->m_items[0];
    CHECK(LCompilers::pickle(*ast) == "(Function f [] [] () () () [] [] [] [(Declaration (AttrType TypeInteger [] () None) [] [(f [] [] () None ())] ())] [(= 0 f 5 ())] [])");

    // AST -> ASR
    LCompilers::SymbolTable::reset_global_counter();
    LCompilers::ASR::TranslationUnit_t* asr = TRY(LCompilers::ast_to_asr(al, *tu,
        diagnostics));
    CHECK(LCompilers::pickle(*asr) == "(TranslationUnit (SymbolTable 1 {f: (Function (SymbolTable 2 {f: (Variable 2 f ReturnVar () () Default (Integer 4 []) Source Public Required .false.)}) f [] [(= (Var 2 f) (IntegerConstant 5 (Integer 4 [])) ())] (Var 2 f) Source Public Implementation ())}) [])");

    // ASR -> LLVM
    LCompilers::LLVMEvaluator e;
    LCompilers::Result<std::unique_ptr<LCompilers::LLVMModule>>
        res = LCompilers::asr_to_llvm(*asr, diagnostics, e.get_context(), al,
            LCompilers::get_platform(), true, LCompilers::get_runtime_library_dir(), "f");
    REQUIRE(res.ok);
...
f = 4
    ...
    LCompilers::AST::TranslationUnit_t* tu = TRY(LCompilers::parse(al, source,
        diagnostics));
    LCompilers::AST::ast_t* ast = tu->m_items[0];
    CHECK(LCompilers::pickle(*ast) == "(Function f [] [] () () () [] [] [] [(Declaration (AttrType TypeInteger [] () None) [] [(f [] [] () None ())] ())] [(= 0 f 4 ())] [])");

    // AST -> ASR
    LCompilers::ASR::TranslationUnit_t* asr = TRY(LCompilers::ast_to_asr(al, *tu,
        diagnostics));
    CHECK(LCompilers::pickle(*asr) == "(TranslationUnit (SymbolTable 3 {f: (Function (SymbolTable 4 {f: (Variable 4 f ReturnVar () () Default (Integer 4 []) Source Public Required .false.)}) f [] [(= (Var 4 f) (IntegerConstant 4 (Integer 4 [])) ())] (Var 4 f) Source Public Implementation ())}) [])");
    // ASR -> LLVM
    LCompilers::LLVMEvaluator e;
    LCompilers::Result<std::unique_ptr<LCompilers::LLVMModule>>
        res = LCompilers::asr_to_llvm(*asr, diagnostics, e.get_context(), al,
