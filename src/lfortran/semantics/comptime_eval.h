#ifndef LCOMPILERS_SEMANTICS_AST_COMPTIME_EVAL_H
#define LCOMPILERS_SEMANTICS_AST_COMPTIME_EVAL_H
...
struct IntrinsicProcedures {
    ...
    */
    ...
    static ASR::expr_t *eval_not(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        ASR::ttype_t* int_type = LCompilers::ASRUtils::TYPE(ASR::make_Integer_t(al, loc, arg_int_type->m_kind, nullptr, 0));
    ...
    static ASR::expr_t *eval_tiny(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        if (ASR::is_a<LCompilers::ASR::Real_t>(*tiny_type)) {
            ...
            // double tiny_val = ASR::down_cast<ASR::RealConstant_t>(LCompilers::ASRUtils::expr_value(tiny_expr))->m_r;
            int tiny_kind = LCompilers::ASRUtils::extract_kind_from_ttype_t(tiny_type);
            if (tiny_kind == 4){
    ...
    static ASR::expr_t *eval_trig(Allocator &al, const Location &loc,
        ...
        } else if (LCompilers::ASR::is_a<LCompilers::ASR::Complex_t>(*t)) {
    ...
    static ASR::expr_t *eval_2args(Allocator &al, const Location &loc,
        ...
        ASR::ttype_t* t1 = LCompilers::ASRUtils::expr_type(args[0]);
        ASR::expr_t* trig_arg2 = args[1];
        ASR::ttype_t* t2 = LCompilers::ASRUtils::expr_type(args[1]);
        if (ASR::is_a<LCompilers::ASR::Real_t>(*t1) && ASR::is_a<LCompilers::ASR::Real_t>(*t2)) {
    ...
    static ASR::expr_t *eval_2args_ri(Allocator &al, const Location &loc,
        ...
        if (ASR::is_a<LCompilers::ASR::Real_t>(*t1) && ASR::is_a<LCompilers::ASR::Real_t>(*t2)) {
            ...
            double val = eval2_double(rv1, rv2);
            return ASR::down_cast<ASR::expr_t>(ASR::make_RealConstant_t(al, loc, val, t1));
        } else if (ASR::is_a<LCompilers::ASR::Integer_t>(*t1) && ASR::is_a<LCompilers::ASR::Integer_t>(*t2)) {
...
TRIG(sqrt)
    ...
    static ASR::expr_t *eval_abs(Allocator &al, const Location &loc,
        ...
        if (LCompilers::ASR::is_a<LCompilers::ASR::Real_t>(*t)) {
            ...
            return ASR::down_cast<ASR::expr_t>(ASR::make_RealConstant_t(al, loc, val, t));
        } else if (LCompilers::ASR::is_a<LCompilers::ASR::Integer_t>(*t)) {
    ...
    static ASR::expr_t *eval_range(Allocator &al, const Location &loc,
        ...
        ASR::ttype_t* tmp_int_type = LCompilers::ASRUtils::TYPE(ASR::make_Integer_t(al, loc, 4, nullptr, 0));
    ...
    static ASR::expr_t *eval_aimag(Allocator &al, const Location &loc,
        ...
        ASR::expr_t* trig_arg = args[0];
        ASR::ttype_t* t = LCompilers::ASRUtils::expr_type(args[0]);
        if (LCompilers::ASR::is_a<LCompilers::ASR::Complex_t>(*t)) {
            double im = ASR::down_cast<ASR::ComplexConstant_t>(trig_arg)->m_im;
            double result = im;
            return ASR::down_cast<ASR::expr_t>(ASR::make_RealConstant_t(al, loc, result, t));
        } else {
    ...
    static ASR::expr_t *eval_int(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        if (LCompilers::ASR::is_a<LCompilers::ASR::Integer_t>(*int_type)) {
            if (int_kind == 4){
                int64_t ival = ASR::down_cast<ASR::IntegerConstant_t>(LCompilers::ASRUtils::expr_value(int_expr))->m_n;
                return ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(al, loc, ival, int_type));
            } else {
                int64_t ival = ASR::down_cast<ASR::IntegerConstant_t>(LCompilers::ASRUtils::expr_value(int_expr))->m_n;
                return ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(al, loc, ival, int_type));
            }
        } else if (LCompilers::ASR::is_a<LCompilers::ASR::Real_t>(*int_type)) {
            if (int_kind == 4){
                float rv = ASR::down_cast<ASR::RealConstant_t>(
                    LCompilers::ASRUtils::expr_value(int_expr))->m_r;
                int64_t ival = static_cast<int64_t>(rv);
                return ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(al, loc, ival, int_type));
            } else {
                double rv = ASR::down_cast<ASR::RealConstant_t>(LCompilers::ASRUtils::expr_value(int_expr))->m_r;
                int64_t ival = static_cast<int64_t>(rv);
                return ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(al, loc, ival, int_type));
            }
        } else {
    ...
    static ASR::expr_t *eval_char(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        if (LCompilers::ASR::is_a<LCompilers::ASR::Integer_t>(*real_type)) {
            ...
            ASR::ttype_t* str_type =
                LCompilers::ASRUtils::TYPE(ASR::make_Character_t(al,
    ...
    static ASR::expr_t *eval_achar(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        ASR::ttype_t* int_type = LCompilers::ASRUtils::expr_type(int_expr);
        if (LCompilers::ASR::is_a<LCompilers::ASR::Integer_t>(*int_type)) {
            int64_t c = ASR::down_cast<ASR::IntegerConstant_t>(LCompilers::ASRUtils::expr_value(int_expr))->m_n;
            ASR::ttype_t* str_type =
                LCompilers::ASRUtils::TYPE(ASR::make_Character_t(al,
                loc, 1, 1, nullptr, nullptr, 0));
            char cc = c;
    ...
    static ASR::expr_t *eval_iachar(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        if (LCompilers::ASR::is_a<LCompilers::ASR::Character_t>(*char_type)) {
            char* c = ASR::down_cast<ASR::StringConstant_t>(LCompilers::ASRUtils::expr_value(char_expr))->m_s;
            ASR::ttype_t* int_type =
                LCompilers::ASRUtils::TYPE(ASR::make_Integer_t(al,
                loc, 4, nullptr, 0));
            return ASR::down_cast<ASR::expr_t>(
    ...
    static ASR::expr_t *eval_selected_int_kind(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        if (LCompilers::ASR::is_a<LCompilers::ASR::Integer_t>(*real_type)) {
            int64_t R = ASR::down_cast<ASR::IntegerConstant_t>(
                LCompilers::ASRUtils::expr_value(real_expr))->m_n;
            int a_kind = 4;
            if (R < 10) {
                a_kind = 4;
            } else {
    ...
    static ASR::expr_t *eval_ibclr(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ...
        ASR::ttype_t* t1 = LCompilers::ASRUtils::expr_type(arg1);
        ASR::ttype_t* t2 = LCompilers::ASRUtils::expr_type(arg2);
        if (ASR::is_a<LCompilers::ASR::Integer_t>(*t1) && ASR::is_a<LCompilers::ASR::Integer_t>(*t2)) {
            ...
            if (t1_kind == 4 && pos >= 0 && pos < 32) {
                ...
                ASR::ttype_t *type = LCompilers::ASRUtils::TYPE(ASR::make_Integer_t(al, loc, t1_kind, nullptr, 0));
                return ASR::down_cast<ASR::expr_t>(ASR::make_IntegerConstant_t(al, loc, val, type));
    ...
    static ASR::expr_t *eval_huge(Allocator &al, const Location &loc, Vec<ASR::expr_t*> &args) {
        ASR::ttype_t* huge_type = LCompilers::ASRUtils::expr_type(args[0]);
        // TODO: Arrays are a valid argument for huge
        if (LCompilers::ASRUtils::is_array(huge_type)) {
            throw SemanticError("Array values not implemented yet", loc);
        }
        if (ASR::is_a<LCompilers::ASR::Integer_t>(*huge_type)) {
            int kind = LCompilers::ASRUtils::extract_kind_from_ttype_t(huge_type);
            if(kind == 4) {
        ...
        } else if (ASR::is_a<LCompilers::ASR::Real_t>(*huge_type)) {
            // TODO: Figure out how to deal with higher precision later
            int kind = LCompilers::ASRUtils::extract_kind_from_ttype_t(huge_type);
            if (kind == 4){
    ...
    static ASR::expr_t *eval_ishft(Allocator &al,
        ...
        ASR::ttype_t* t1 = LCompilers::ASRUtils::expr_type(i);
        ASR::ttype_t* t2 = LCompilers::ASRUtils::expr_type(shift);
        if (ASR::is_a<LCompilers::ASR::Integer_t>(*t1) &&
                ASR::is_a<LCompilers::ASR::Integer_t>(*t2)) {
            int t1_kind = ASRUtils::extract_kind_from_ttype_t(t1);
            int t2_kind = ASRUtils::extract_kind_from_ttype_t(t2);
            if (t1_kind == 4 && t2_kind == 4) {
...
#endif /* LCOMPILERS_SEMANTICS_AST_COMPTIME_EVAL_H */
