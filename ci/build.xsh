...
# modes:
BUILD_TYPE = "Release"
cmake -G $LCOMPILERS_CMAKE_GENERATOR -DCMAKE_VERBOSE_MAKEFILE=ON -DWITH_LLVM=yes -DWITH_XEUS=yes -DCMAKE_PREFIX_PATH=$CONDA_PREFIX -DCMAKE_INSTALL_PREFIX=$CONDA_PREFIX -DCMAKE_BUILD_TYPE=@(BUILD_TYPE) ..
...
if $WIN != "1":
    ...
    $FC="../../src/bin/lfortran"
    cmake -DLCOMPILERS_BACKEND=llvm ..
    make
    ctest -L llvm
    cd ../..
